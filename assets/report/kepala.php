...
<head>
	...
	<style>
		...
		.logo{ width: 10%; float:left; font-weight: normal; position: absolute; }
		.info{ width: 100%; text-align: center; margin-top: -20px; line-height: 0.7; float:right; font-weight: normal; }		
		#kiri{
			width: 78%; height: 100px; float:left; font-weight: normal;
		}
		#kanan{
			width: 22%; height: 100px; float:right; font-weight: normal;
		}
