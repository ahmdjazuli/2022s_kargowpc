...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-dark">
  <div class="container-fluid">
    ...
    <span class='badge bg-orange' style="font-size: 100%;"><span style="font-weight: normal;">admin</span></span>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="barang.php" data-toggle="tooltip" title="Data Barang"><i class="fas fa-coins"></i></a>
          </li>
          <li class="nav-item text-white"> <a class="nav-link" href="#">|</a> </li>
          <li class="nav-item">
            <a class="nav-link" href="barangmasuk.php" data-toggle="tooltip" title="Barang Masuk"><i class="fas fa-shopping-basket"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="barangrusak.php" data-toggle="tooltip" title="Barang Rusak"><i class="fas fa-dragon"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="qc.php" data-toggle="tooltip" title="Quality Check"><i class="fas fa-gem"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="transaksi.php" data-toggle="tooltip" title="Transaksi"><i class="fas fa-shopping-bag"></i></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="grafik.php" data-toggle="tooltip" title="Grafik Pendapatan Bulanan"><i class="fas fa-money-bill"></i></a>
          </li>
        </ul>
      </div>
